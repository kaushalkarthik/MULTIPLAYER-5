    ...
    displayRanks(){
        ...
        for(var plr in allPlayers){
            if(allPlayers[plr].rank===1){
                text("firstRank:"+allPlayers[plr].name,200,150)

            }
            else  if(allPlayers[plr].rank===2){
                text("secondRank:"+allPlayers[plr].name,200,215)

            
            }
            else  if(allPlayers[plr].rank===3){
                text("thirdRank:"+allPlayers[plr].name,200,285)

           
            }
            else{
                text("fourthRank:"+allPlayers[plr].name,200,350)
